...
# Variables
$GroupName = "PWD_Policy_Exclusion_Admin_Accounts"

$TargetOU = "OU=IT,DC=EWCN,DC=EWBC,DC=NET" # Replace with your OU's distinguished name

## Excluded users must be specified with their distinguished name:
$excludedUsers = @"
CN=SecretUA,OU=Admins,OU=IT,DC=EWCN,DC=EWBC,DC=NET
CN=SecretEnableUA,OU=Admins,OU=IT,DC=EWCN,DC=EWBC,DC=NET
CN=test LYNCuser,OU=IT,DC=EWCN,DC=EWBC,DC=NET
"@
